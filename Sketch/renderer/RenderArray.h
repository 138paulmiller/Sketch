...
class RenderArray : public Renderable
{
protected:
...
public:
	RenderArray(GLuint drawMode = GL_TRIANGLES);
	virtual  ~RenderArray();
	...
	*/
	...
	virtual void onBind()			{ DebugAssert(true); }	/* RenderArray No Color!Superclass Must Override! use Shader::currnet()!    */
	virtual void onUnbind()			{ DebugAssert(true); }	/* RenderArray No Color!Superclass Must Override! use Shader::currnet()!    */
	virtual void onRender()			{ }	/* RenderArray No Color!Superclass Must Override! use Shader::currnet()!    */
	virtual void onPreRender()			{ }	/* RenderArray No Color!Superclass Must Override! use Shader::currnet()!    */


};

#include <renderer/RenderArray.hpp>
